<%@ Page Language="C#" MasterPageFile="~/mpageManager.master" AutoEventWireup="true" CodeFile="DEntryGuideDetails.aspx.cs" Inherits="DEntryGuideDetails" Title="ورود اطلاعات راهنما" %>
            ...
            <td align="right" colspan="3" dir="rtl" rowspan="3" style="width: 766px; height: 114px">
                <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="4"
                    ...
                    <Fields>
                        <asp:TemplateField HeaderText="عنوان ">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox2" runat="server" BorderWidth="0px" Font-Bold="True" Font-Italic="True"
                                    ...
                                    Height="40px" Text='<%# Bind("GTitle") %>' TextMode="MultiLine" Width="453px"></asp:TextBox>&nbsp;
                            </EditItemTemplate>
                            <InsertItemTemplate>
                                <asp:TextBox ID="TextBox2" runat="server" BorderWidth="0px" Font-Bold="True" Font-Italic="True"
                                    Font-Names="Tahoma" Font-Size="10pt" Font-Underline="True" ForeColor="#993300"
                        ...
                        <asp:TemplateField HeaderText="راهنما">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" BorderWidth="0px" Font-Bold="True" Font-Names="Tahoma"
                                    Font-Size="X-Small" ForeColor="Navy" Height="292px" Text='<%# Bind("GText") %>'
                            ...
                            <ItemTemplate>
                                &nbsp;<asp:TextBox ID="TextBox1" runat="server" BorderWidth="0px" Font-Bold="True"
                                    ...
                                    Text='<%# Bind("GText") %>' TextMode="MultiLine" Width="453px"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="تصوير">
                            ...
                            <InsertItemTemplate>
                                <asp:FileUpload ID="fuPicture" runat="server" Font-Names="Tahoma" Width="393px" />
                            </InsertItemTemplate>
                            <ItemTemplate>
                                <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("GId","CategoriesImage4.aspx?id={0}") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <InsertItemTemplate>
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/DEntryGuide.aspx" Font-Names="Tahoma" Font-Size="8pt" ForeColor="#CC3300">برگشت به لیست</asp:HyperLink><br />
                <br />
                <br />
                <br />
                <br />

<%@ Page Language="C#" MasterPageFile="~/mpageMemb.master" AutoEventWireup="true" CodeFile="ArchiveReqPart.aspx.cs" Inherits="ArchiveReqPart" Title="آرشيو درخواست قطعه نماينده" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table>
        <tr>
            <td colspan="5" style="height: 33px">
                <asp:TextBox ID="txtCatId" runat="server" Visible="False" Width="25px">1</asp:TextBox>
                <asp:Image ID="Image3" runat="server" Height="29px" ImageUrl="~/Images/AMRP2.gif" Width="178px" /></td>
        </tr>
        <tr>
            <td align="center" colspan="5" style="height: 14px" valign="top">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="8pt"
                    ForeColor="#003399" Height="19px" Text="Label" Width="239px"></asp:Label></td>
        </tr>
        <tr>
            <td align="right" colspan="5" dir="rtl" rowspan="1" style="height: 105px" valign="top">
                <asp:GridView ID="grdMails" runat="server" AutoGenerateColumns="False"
                    Height="86px" OnRowCommand="grdMails_RowCommand" Width="513px" CellPadding="4" Font-Names="Tahoma" Font-Size="8pt" ForeColor="#003399" GridLines="None">
                    <Columns>
                        <asp:BoundField DataField="ReqPId" HeaderText="کد" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ReqDate" HeaderText="تاريخ" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
        ...
        <tr>
            <td align="right" colspan="5" dir="rtl" rowspan="1" style="height: 94px" valign="top">
                &nbsp;<asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False"
                    CellPadding="4" Font-Bold="True" Font-Names="Tahoma" Font-Size="X-Small" ForeColor="#333333"
                    GridLines="None" Height="190px" Width="510px">
                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                    ...
                    <Fields>
                        ...
                        <asp:CheckBoxField DataField="chkRec" HeaderText="مشاهده شد">
                            <HeaderStyle ForeColor="Purple" Width="200px" />
                            <ItemStyle Width="300px" />
                        </asp:CheckBoxField>
                        <asp:TemplateField HeaderText="پاسخ مديريت">
                            <ItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" BorderWidth="0px" Font-Bold="True" Font-Names="Tahoma"
                                    Font-Size="8pt" ForeColor="#003399" Height="149px" Text='<%# Bind("RAnswer") %>'
        ...
        <tr>
            <td align="right" colspan="5" dir="rtl" rowspan="1" style="height: 105px" valign="top">
                <asp:GridView ID="grdDetail" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    OnRowCommand="grdMails_RowCommand" PageSize="3" Visible="False" Width="501px">
                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                    <RowStyle BackColor="#EFF3FB" />
                    <Columns>
